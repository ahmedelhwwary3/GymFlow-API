...
{
    internal class WorkoutPlanConfigurations : IEntityTypeConfiguration<Entities.WorkoutPlan>
    {
        public void Configure(EntityTypeBuilder<Entities.WorkoutPlan> builder)
        {
